...
export default function LearnPage() {
  return (
    <>
      ...
      {/* Section Navigation */}
      <section className="bg-white py-20 lg:py-28 border-b border-grey-200">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {sections.map((s) => (
              <a
                key={s.id}
                href={`#${s.id}`}
                className="p-8 rounded-2xl bg-grey-50 border border-grey-200 hover:border-primary/30 hover:shadow-md transition-all group"
              >
                <s.icon
                  size={24}
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <article
                key={post.title}
                className="group rounded-2xl border border-grey-200 bg-white overflow-hidden hover:shadow-lg transition-all"
              >
      ...
      <section id="tutorials" className="bg-white py-20 lg:py-28">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="p-8 rounded-2xl bg-grey-50 border border-grey-200 text-center max-w-2xl mx-auto">
      ...
      <section id="press" className="bg-grey-50 py-20 lg:py-28">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          <div className="p-8 rounded-2xl bg-white border border-grey-200 text-center max-w-2xl mx-auto">
