    ...
    <>
      ...
      <section className="bg-grey-50 py-16 lg:py-20 border-t border-grey-200">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          ...
          {/* Flow diagram */}
          <div className="hidden lg:grid grid-cols-[minmax(220px,1fr)_40px_minmax(260px,1.2fr)_40px_minmax(220px,1fr)] items-stretch gap-0 mb-16">
            {/* Data Sources (spans all center rows) */}
            <div className="col-start-1 row-span-3 rounded-2xl border border-grey-200 bg-white p-6 text-center shadow-sm flex items-center justify-center">
              <div>
                ...
                <h3 className="text-[16px] font-semibold text-grey-900 mb-1">
                  Data Sources
                </h3>
            ...
            {/* Arrow: Data Sources -> Cimba */}
            <div className="col-start-2 row-start-1 flex items-center justify-center">
              <ArrowRight size={20} className="text-grey-300" />
            </div>

            {/* Cimba */}
            <div
              className="col-start-3 row-start-1 rounded-2xl border-2 border-transparent p-6 text-center shadow-md flex items-center justify-center"
              style={{
                background:
            ...
            {/* Arrow: Data Sources -> BI */}
            <div className="col-start-2 row-start-2 flex items-center justify-center">
              <ArrowRight size={20} className="text-grey-300" />
            </div>

            {/* BI Tools */}
            <div className="col-start-3 row-start-2 rounded-2xl border border-grey-200 bg-white p-6 text-center shadow-sm flex items-center justify-center">
              <div>
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-grey-100">
                  <BarChart3 size={22} className="text-grey-600" />
                </div>
                <h3 className="text-[16px] font-semibold text-grey-900 mb-1">BI Tools</h3>
                <p className="text-[16px] text-grey-500 leading-relaxed">
            ...
            {/* Arrow: Data Sources -> AI */}
            <div className="col-start-2 row-start-3 flex items-center justify-center">
              <ArrowRight size={20} className="text-grey-300" />
            </div>

            {/* AI Tools */}
            <div className="col-start-3 row-start-3 rounded-2xl border border-grey-200 bg-white p-6 text-center shadow-sm flex items-center justify-center">
              <div>
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-grey-100">
                  <Sparkles size={22} className="text-grey-600" />
                </div>
                <h3 className="text-[16px] font-semibold text-grey-900 mb-1">AI Tools</h3>
                <p className="text-[16px] text-grey-500 leading-relaxed">
            ...
            {/* Teams (spans all center rows) */}
            <div className="col-start-5 row-span-3 rounded-2xl border border-grey-200 bg-white p-6 text-center shadow-sm flex items-center justify-center">
              <div>
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-grey-100">
          ...
          {/* Mobile flow diagram (keeps the existing simpler layout) */}
          <div className="lg:hidden flex flex-col items-center lg:items-stretch gap-0 mb-16">
            {/* Data Sources */}
            <div className="w-full rounded-2xl border border-grey-200 bg-white p-6 text-center shadow-sm">
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-grey-100">
                <Database size={22} className="text-grey-600" />
              </div>
            ...
            <div className="flex items-center justify-center px-3 py-4">
              <ArrowRight size={20} className="text-grey-300 rotate-90" />
            </div>

            {/* Cimba */}
            <div
              className="w-full rounded-2xl border-2 border-transparent p-6 text-center shadow-md"
              style={{
                background:
                  "linear-gradient(white, white) padding-box, linear-gradient(to right, rgba(31, 151, 211, 0.5), rgba(116, 20, 218, 0.5) 47%, rgba(7, 112, 227, 0.5)) border-box",
                backgroundClip: "padding-box, border-box",
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
            <div className="flex-1 flex flex-col sm:flex-row gap-4 lg:hidden">
